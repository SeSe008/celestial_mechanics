...
pub fn calculate_escape_velocity(d: f64, d_earth: f64, m: f64, m_earth: f64) -> f64 {
    // Convert Earth radii to meters
    let radius_m = (d * d_earth * 1000.0) / 2.0; // Earth-ratio-diameter in meters, then to radius
