        ...
        <div id="inputs">
                    ...
                    <select on:change=move |ev| {
                        ...
                        if index == 0 {
                            for i in 0..input_sliders.length() {
                                ...
                                planet_signal.1.set(create_planet(1.0, 0.017, 1.0, 1.0));
                            }
                        } else {
                            for i in 0..input_sliders.length() {
            ...
            <div class="input_section">
                <div class="input_slider input">
                    ...
                    <input type="range" min="1" max="750.0" step="0.01" value={planet_signal.0.get_untracked().a_input.0.get_untracked()} on:input=move |ev| {
                ...
                <div class="input_slider input">
                    ...
                    <input type="range" min="0" max=".99" step="0.01" value={planet_signal.0.get_untracked().e.0.get_untracked()} on:input=move |ev| {
            ...
            <div class="input_section">
                <div class="input_slider input">
                    ...
                    <input type="range" min="0.01" max="330" step="0.01" value={planet_signal.0.get_untracked().m_object.0.get_untracked()} on:input=move |ev| {
                ...
                <div class="input_slider input">
                    ...
                    <input type="range" min="0.01" max="12" step="0.01" value={planet_signal.0.get_untracked().d.0.get_untracked()} on:input=move |ev| {
